...
- Data reduction across processes
"""
...
def init_distributed_mode(args):
    ...
    Args:
        args: Arguments namespace with distributed settings

    Returns:
        args: Updated arguments with distributed settings
    """
    if args.dist_on_itp:
...
def all_reduce_mean(x):
    """Reduce and average tensor across all processes."""
